...
export const countryProfiles: CountryProfile[] = [
  ...
  },
  {
    ...
    factors: {
      ...
      geopoliticalRisk: 37,
      dealExecutionRisk: 45,
    },
    notes:
      'Deep services base and mature PE ecosystem; post-Brexit compliance interfaces can add transactional friction.',
    confidence: 0.82,
    lastUpdated: '2026-03-07',
    sources: ['Bank of England', 'IMF WEO', 'OECD statistics', 'UK CMA updates'],
  },
  {
    code: 'FR',
    name: 'France',
    ...
    sectorFit: {
      ...
      'Healthcare Services': 82,
      'Industrial Technology': 81,
    },
    factors: {
      economicStrength: 77,
      regulatoryComplexity: 64,
      taxTariffFriction: 58,
      geopoliticalRisk: 40,
      dealExecutionRisk: 50,
    },
    notes:
      'Large domestic market with strong healthcare and industrial assets; labor and administrative complexity can slow integration.',
    confidence: 0.8,
    lastUpdated: '2026-03-07',
    sources: ['Banque de France', 'IMF Article IV', 'OECD', 'EU regulatory publications'],
  },
  {
    code: 'NL',
    name: 'Netherlands',
    ...
    sectorFit: {
      ...
      'Healthcare Services': 78,
      'Industrial Technology': 83,
    },
    factors: {
      economicStrength: 80,
      regulatoryComplexity: 55,
      taxTariffFriction: 49,
      geopoliticalRisk: 36,
      dealExecutionRisk: 44,
    },
    notes:
      'Trade-oriented economy and strong logistics/tech base; EU-level and local compliance requirements still require careful structuring.',
    confidence: 0.81,
    lastUpdated: '2026-03-07',
    sources: ['DNB', 'IMF', 'OECD', 'EU trade and competition reports'],
  },
  {
    code: 'JP',
    name: 'Japan',
    ...
    notes:
      'High-quality industrial and healthcare ecosystems; demographic pressures and execution pace can affect value-creation timelines.',
    confidence: 0.79,
    lastUpdated: '2026-03-07',
    sources: ['Bank of Japan', 'IMF WEO', 'OECD data', 'METI releases'],
  },
  {
    code: 'AU',
    name: 'Australia',
    ...
    factors: {
      economicStrength: 79,
      regulatoryComplexity: 51,
      taxTariffFriction: 50,
      geopoliticalRisk: 34,
      dealExecutionRisk: 42,
    },
    notes:
      'Stable legal framework and transparent institutions; sector-specific review regimes can shape timing for foreign acquirers.',
    confidence: 0.8,
    lastUpdated: '2026-03-07',
    sources: ['RBA', 'IMF', 'World Bank', 'Australian Competition and Consumer Commission'],
  },
  {
    code: 'IN',
    name: 'India',
    ...
    factors: {
      ...
      geopoliticalRisk: 52,
      dealExecutionRisk: 59,
    },
    notes:
      'High growth potential and large domestic demand, with meaningful upside for services and tech; multi-layered compliance requires local execution depth.',
    confidence: 0.76,
    lastUpdated: '2026-03-07',
    sources: ['RBI', 'IMF WEO', 'World Bank', 'OECD and national trade data'],
  },
  {
    code: 'BR',
    name: 'Brazil',
    ...
    sectorFit: {
      ...
      'Healthcare Services': 76,
      'Industrial Technology': 72,
    },
    factors: {
      economicStrength: 71,
      regulatoryComplexity: 67,
      taxTariffFriction: 66,
      geopoliticalRisk: 45,
      dealExecutionRisk: 58,
    },
    notes:
      'Scale market with broad sector opportunities; tax complexity and operational execution variability are primary diligence drivers.',
    confidence: 0.73,
    lastUpdated: '2026-03-07',
    sources: ['Brazil Central Bank', 'IMF', 'World Bank', 'OECD indicators'],
  },
  {
    code: 'MX',
    name: 'Mexico',
    ...
    factors: {
      ...
      taxTariffFriction: 57,
      geopoliticalRisk: 49,
      dealExecutionRisk: 56,
    },
    notes:
      'Strong nearshoring relevance and US value-chain connectivity; security, policy, and enforcement variance must be underwritten explicitly.',
    confidence: 0.74,
    lastUpdated: '2026-03-07',
    sources: ['Banco de México', 'IMF', 'World Bank', 'OECD trade statistics'],
  },
]
