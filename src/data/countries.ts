...
const baseProfiles: Omit<CountryProfile, 'factorCitations' | 'sources'>[] = [
  {
    ...
    sectorFit: { 'Professional Services': 86, 'Healthcare Services': 88, 'Industrial Technology': 82, 'Defense / A&D': 90 },
  ...
  },
  {
    ...
    name: 'Germany',
    region: 'Europe',
    sectorFit: { 'Professional Services': 78, 'Healthcare Services': 81, 'Industrial Technology': 89, 'Defense / A&D': 85 },
  ...
  },
  {
    ...
    name: 'Singapore',
    region: 'Asia-Pacific',
    sectorFit: { 'Professional Services': 84, 'Healthcare Services': 75, 'Industrial Technology': 80, 'Defense / A&D': 67 },
  ...
  },
  {
    ...
    name: 'Canada',
    region: 'North America',
    sectorFit: { 'Professional Services': 79, 'Healthcare Services': 77, 'Industrial Technology': 74, 'Defense / A&D': 75 },
  ...
  },
  {
    ...
    region: 'Middle East',
    sectorFit: { 'Professional Services': 81, 'Healthcare Services': 73, 'Industrial Technology': 76, 'Defense / A&D': 80 },
  ...
  },
  {
    ...
    name: 'United Kingdom',
    region: 'Europe',
    sectorFit: { 'Professional Services': 85, 'Healthcare Services': 79, 'Industrial Technology': 77, 'Defense / A&D': 88 },
  ...
  },
  {
    ...
    name: 'France',
    region: 'Europe',
    sectorFit: { 'Professional Services': 77, 'Healthcare Services': 82, 'Industrial Technology': 81, 'Defense / A&D': 84 },
  ...
  },
  {
    ...
    name: 'Netherlands',
    region: 'Europe',
    sectorFit: { 'Professional Services': 82, 'Healthcare Services': 78, 'Industrial Technology': 83, 'Defense / A&D': 70 },
  ...
  },
  {
    ...
    name: 'Japan',
    region: 'Asia-Pacific',
    sectorFit: { 'Professional Services': 75, 'Healthcare Services': 83, 'Industrial Technology': 88, 'Defense / A&D': 72 },
  ...
  },
  {
    ...
    name: 'Australia',
    region: 'Asia-Pacific',
    sectorFit: { 'Professional Services': 80, 'Healthcare Services': 79, 'Industrial Technology': 76, 'Defense / A&D': 78 },
  ...
  },
  {
    ...
    name: 'India',
    region: 'Asia-Pacific',
    sectorFit: { 'Professional Services': 86, 'Healthcare Services': 74, 'Industrial Technology': 82, 'Defense / A&D': 82 },
  ...
  },
  {
    ...
    sectorFit: { 'Professional Services': 74, 'Healthcare Services': 76, 'Industrial Technology': 72, 'Defense / A&D': 68 },
  ...
  },
  {
    ...
    name: 'Mexico',
    region: 'Latin America',
    sectorFit: { 'Professional Services': 77, 'Healthcare Services': 71, 'Industrial Technology': 79, 'Defense / A&D': 65 },
